...
| `src/components/add-company-form/steps/ConfidentialContactStep.vue` (formulaire confidentiel) | `ConfidentialContactStep.test.js` | Rien n'est vérifié (aucun format) ni obligatoire : un formulaire entièrement vide est accepté ; plusieurs champs remplis (email perso, email étudiant, WhatsApp, LinkedIn) sont tous conservés, les vides omis |
